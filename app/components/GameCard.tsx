    ...
    return (
      <div className="w-full flex flex-col space-y-6 items-center">
        ...
        {scrambleInput.length > 0 && isCorrect && (
          <div className="text-[var(--node-linked)] font-bold text-center animate-bounce text-xl">
    ...
    return (
      <div className="w-full flex flex-col space-y-6">
        ...
        {blankInput.length > 0 && isCorrect && (
          <div className="text-[var(--node-hover)] font-bold text-center animate-bounce text-xl">
