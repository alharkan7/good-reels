  ...
  return (
    <div className="w-full flex flex-col items-center justify-between h-[60dvh]">
      ...
      <div className="flex w-full gap-4 mt-auto">
        ...
        >
          <Box size={24} strokeWidth={2} className="mb-2 opacity-50 group-hover:opacity-100 transition-opacity" />
        ...
        >
          <Inbox size={24} strokeWidth={2} className="mb-2 opacity-50 group-hover:opacity-100 transition-opacity" />
